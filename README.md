...
| **Task Manager MCP** | 8010 | MCP server (Streamable HTTP) backed by AlloyDB. Exposes task CRUD plus AlloyDB AI tools (vector search, smart filter, summary generation). |